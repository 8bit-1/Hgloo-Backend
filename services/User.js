...
async function getShowComents(idUser,init,fin){
    ...
    const result = await db.queryP(`SELECT c.idComentarios as idComentario,u.urlfotoPerfil,c.Comentado,u.nombreUsuario,u.correo,c.comentario, c.fecha from comentario c
